 ...
 */
abstract class Quangcao implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\QuangcaoTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Quangcao object.
     */
    ...
    /**
     * Compares this with another <code>Quangcao</code> instance.  If
     * <code>obj</code> is an instance of <code>Quangcao</code>, delegates to
     * <code>equals(Quangcao)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Quangcao The current object, for fluid interface
     */
    ...
    public function setNoidung($v)
    {
        ...
        if ($this->noidung !== $v) {
            $this->noidung = $v;
            $this->modifiedColumns[QuangcaoTableMap::COL_NOIDUNG] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildQuangcaoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Quangcao::setDeleted()
     * @see Quangcao::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildQuangcaoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                QuangcaoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aLoaiquangcao !== null) {
                if ($this->aLoaiquangcao->isModified() || $this->aLoaiquangcao->isNew()) {
                    $affectedRows += $this->aLoaiquangcao->save($con);
                }
                $this->setLoaiquangcao($this->aLoaiquangcao);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO QuangCao (%s) VALUES (%s)',
    ...
    {
        $pos = QuangcaoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Quangcao'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aLoaiquangcao) {
                ...
                $result[$key] = $this->aLoaiquangcao->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Quangcao The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Quangcao (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Quangcao Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildLoaiquangcao object.
     *
     * @param  ChildLoaiquangcao $v
     * @return $this|\Model\Quangcao The current object (for fluent API support)
     * @throws PropelException
     */
    public function setLoaiquangcao(ChildLoaiquangcao $v = null)
    {
        ...
        // If this object has already been added to the ChildLoaiquangcao object, it will not be re-added.
        if ($v !== null) {
            $v->addQuangcao($this);
        }
    ...
    /**
     * Get the associated ChildLoaiquangcao object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildLoaiquangcao The associated ChildLoaiquangcao object.
     * @throws PropelException
     */
    public function getLoaiquangcao(ConnectionInterface $con = null)
    {
        if ($this->aLoaiquangcao === null && ($this->loaiquangcao_maloaiquangcao !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLoaiquangcao->addQuangcaos($this);
             */
        }

        return $this->aLoaiquangcao;
    }
    ...
    {
        return (string) $this->exportTo(QuangcaoTableMap::DEFAULT_STRING_FORMAT);
    }
