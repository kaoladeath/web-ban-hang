...
abstract class Admin implements ActiveRecordInterface
{
    ...
    /**
     * The value for the maadmin field.
     *
     * @var        int
     */
    protected $maadmin;
    ...
    public function setMaadmin($v)
    {
        ...
        if ($this->maadmin !== $v) {
            $this->maadmin = $v;
            $this->modifiedColumns[AdminTableMap::COL_MAADMIN] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AdminTableMap::translateFieldName('Maadmin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->maadmin = (null !== $col) ? (int) $col : null;
            ...
            return $startcol + 3; // 3 = AdminTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'MaAdmin':
                        $stmt->bindValue($identifier, $this->maadmin, PDO::PARAM_INT);
                        break;
                    case 'UserName':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_MAADMIN)) {
            $criteria->add(AdminTableMap::COL_MAADMIN, $this->maadmin);
        }
        if ($this->isColumnModified(AdminTableMap::COL_USERNAME)) {
    ...
    /**
     * Generic method to set the primary key (maadmin column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setMaadmin(NULL); // this is a auto-increment column, so set to default value
        }
    }
