 ...
 * @method     ChildQuangcao findOneByHinhanh(resource $HInhAnh) Return the first ChildQuangcao filtered by the HInhAnh column
 ...
 * @method     ChildQuangcao requireOneByHinhanh(resource $HInhAnh) Return the first ChildQuangcao filtered by the HInhAnh column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildQuangcao[]|ObjectCollection findByHinhanh(resource $HInhAnh) Return ChildQuangcao objects filtered by the HInhAnh column
...
abstract class QuangcaoQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT MaQuangCao, NoiDung, NgayDang, Link, LoaiQuangCao_MaLoaiQuangCao FROM QuangCao WHERE MaQuangCao = :p0 AND LoaiQuangCao_MaLoaiQuangCao = :p1';
        try {
     ...
     *
     * @param     mixed $hinhanh The value to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildQuangcaoQuery The current query, for fluid interface
     */
