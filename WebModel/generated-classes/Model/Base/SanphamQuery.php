 ...
 * @method     ChildSanpham findOneByHinhanh(resource $HInhAnh) Return the first ChildSanpham filtered by the HInhAnh column
 ...
 * @method     ChildSanpham requireOneByHinhanh(resource $HInhAnh) Return the first ChildSanpham filtered by the HInhAnh column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSanpham[]|ObjectCollection findByHinhanh(resource $HInhAnh) Return ChildSanpham objects filtered by the HInhAnh column
...
abstract class SanphamQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT MaSanpham, TenSanpham, GiaSP, DonViTinh, ThongTin, LoaiSP_MaLoaiSP FROM Sanpham WHERE MaSanpham = :p0';
        try {
